...
.dx-datagrid .dx-editor-cell input {
  background-color: #333 !important; /* Fundo escuro */
  color: #fff !important; /* Texto claro */
}

.dx-datagrid .dx-editor-cell input::placeholder {
  color: rgba(255, 255, 255, 0.6) !important; /* Placeholder visível */
}
</style>
